 ...
 * @method static bool   containsAll(string $stringInput, array<string> $needle, bool $caseSensitive = true, string $encoding = null)
 ...
 * @method static Stringy replaceAll(string $stringInput, array<string> $search, string $replacement, bool $caseSensitive, string $encoding = null)
